...
describe('settings test suite', () => {
    ...
    test('tests post /settings endpoint no internship period', async() => {
        const payload = {email_dir: 'qwerty', resume_dir: '02/12/2023 - 10/12/2024'};
        const res = await request
                    .post('/api/v1/settings')
                    .send(payload)
                    .set('Content-Type', 'application/json')
    ...
    test('tests post /settings endpoint no resume dir', async() => {
        const payload = {email_dir: 'qwerty', internship_period: '02/12/2023 - 10/12/2024' };
        const res = await request
                    .post('/api/v1/settings')
                    .send(payload)
                    .set('Content-Type', 'application/json')
    ...
    test('tests post /settings endpoint no email dir', async() => {
        const payload = {resume_dir: 'qwerty', internship_period: '02/12/2023 - 10/12/2024' };
        const res = await request
                    .post('/api/v1/settings')
                    .send(payload)
                    .set('Content-Type', 'application/json')
    ...
    test('tests post /settings endpoint missing "/" in period', async() => {
        const payload = {email_dir: 'qwerty', resume_dir: 'qwerty', internship_period: '02122023 - 10122024' };
        const res = await request
                    .post('/api/v1/settings')
                    .send(payload)
                    .set('Content-Type', 'application/json')
